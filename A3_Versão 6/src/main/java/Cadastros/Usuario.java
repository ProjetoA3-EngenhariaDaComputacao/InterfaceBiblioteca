...
public class Usuario {
    ...
    public Usuario(String cpf, String nome, String email, String usuario, String senha, int tipoUsu) {
        this.cpf = cpf;
        this.nome = nome;
        this.email = email;
    ...
    public void inserir() throws SQLException
    {
        ...
        String sql = "INSERT INTO pessoa(nome, email, usuario, senha, tipousu) "
                + "VALUES (?, ?, ?, ?, ?)";
